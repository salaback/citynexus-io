        ...
        <form class="form-horizontal" role="form" method="post" action="{{route('users.update', [$user->id])}}">
            ...
            <section class="boxs">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="first_name" id="first_name" class="form-control" value="{{$user->first_name}}" title="" required="required" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="first_name" class="col-sm-4 control-label">Last Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="last_name" id="last_name" class="form-control" value="{{$user->last_name}}" title="" required="required" >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="department" id="department" class="form-control" value="{{$user->info->department}}" title=""  >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="title" class="col-sm-4 control-label">Title</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="title" id="title" class="form-control" value="{{$user->info->title}}" title=""  >
                                    </div>
                                </div>
                            </div>
                ...
                <div class="boxs-footer">
                    <input type="submit" class="btn btn-raised btn-primary" value="Update User">
                </div>
            </section>
        </form>
        @unless(\Illuminate\Support\Facades\Auth::id() == $user->id)
            <div class="boxs-footer">
                <form action="{{route('users.destroy', [$user->id])}}" method="post">
                    ...
                    <button class="btn btn-raised btn-danger">Remove User from Organization</button>
                </form>
            </div>
        @endunless
    </div>
