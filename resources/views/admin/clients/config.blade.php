        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="config[app_key]" id="inputID" class="form-control" title="" value="{{$config['app_key'] || ''}}" required="required">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="config[city]" id="inputID" class="form-control" title="" value="{{$config['city'] || ''}}" required="required">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="config[state]" id="inputID" class="form-control" title="" value="{{$config['state'] || ''}}" required="required">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="config[map_lat]" id="inputID" class="form-control" title="" value="{{$config['map_lat'] || ''}}" required="required">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="config[map_lng]" id="inputID" class="form-control" title="" value="{{$config['map_lng'] || ''}}" required="required">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="config[map_zoom" id="" class="form-control">
                            ...
                            <option value="7" @if(!isset($config['map_zoom']))selected @endif>7</option>
                            ...
                            <option value="15" @if(isset($config['map_zoom']) && $config['map_zoom'] == 15)selected @endif>15</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="config[gmap_API]" id="inputID" class="form-control" title="" value="{{$config['gmap_API'] || null}}" required="required">
                    </div>
                </div>
