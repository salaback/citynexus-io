            ...
            <div class="boxs-body">
                <form role="form">
                    <div class="form-group">
                        ...
                        <input type="text" name="settings[table_name]" class="form-control" id="table_name" value="{{$uploader->settings['table_name']}}">
                        <span class="material-input"></span></div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Host</label>
                        <input type="text" name="settings[host]" class="form-control" id="host" value="{{$uploader->settings['host']}}">
                        <span class="material-input"></span></div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Host</label>
                        <select name="settings[driver]" class="form-control mb-10 parsley-success" data-parsley-trigger="change" required="" data-parsley-id="8432">
                            ...
                            <option value="pgsql" @if($uploader->settings['driver'] == 'pgsql') selected @endif>Postgres</option>
                            <option value="mysql" @if($uploader->settings['driver'] == 'mysql') selected @endif >MySQL</option>
                        </select>
                        <span class="material-input"></span></div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Database Name</label>
                        <input type="text" name="settings[database]" class="form-control" id="database" value="{{$uploader->settings['database']}}">
                        <span class="material-input"></span></div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">User Name</label>
                        <input type="text" name="settings[username]" class="form-control" id="username" value="{{$uploader->settings['username']}}">
                        <span class="material-input"></span></div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Password</label>
                        <input type="password" name="settings[password]" class="form-control" id="password" value="{{$uploader->settings['password']}}">
                        <span class="material-input"></span></div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Schema</label>
                        <input type="text" name="settings[schema]" class="form-control" id="schema" value="{{$uploader->settings['schema']}}">
                        <span class="material-input"></span></div>
